...
int total=0;
try{
	String sql="select to_char(i.inOutDate,'YYYY-MM-DD'),i.storeCode,s.storeName,i.productCode,p.productName,i.saleQty,p.unitPrice from product08182 p,store08182 s,inOut0818 i where i.productCode=p.productCode and i.storeCode=s.storeCode and gubun=1 order by i.inOutDate asc,s.storeCode asc";
